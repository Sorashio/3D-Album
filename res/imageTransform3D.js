...
ge1doot.transform3D.Image.prototype.triangulate = function(p0, p1, p2, level) {
  ...
  if (level === 0) {
    ...
    // ---- insert new points ----
    this.points.push(
      (p01 = new ge1doot.transform3D.Point(p01.x, p01.y, p01.z, p01.tx, p01.ty))
    );
    this.points.push(
      (p12 = new ge1doot.transform3D.Point(p12.x, p12.y, p12.z, p12.tx, p12.ty))
    );
    this.points.push(
      (p20 = new ge1doot.transform3D.Point(p20.x, p20.y, p20.z, p20.tx, p20.ty))
    );
